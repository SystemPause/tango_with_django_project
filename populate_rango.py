...
def populate():
    ...
    python_pages = [
        ...
        {"title":"Learn Python in 10 Minutes",
         "url":"http://www.korokithakis.net/tutorials/python/","views":92} ]
    
    
    django_pages = [
        {"title":"Official Django Tutorial",
         "url":"https://docs.djangoproject.com/en/1.9/intro/tutorial01/","views":456},
        {"title":"Django Rocks",
         "url":"http://www.djangorocks.com/","views":42},
        {"title":"How to Tango with Django",
         "url":"http://www.tangowithdjango.com/","views":66} ]
    
    other_pages = [
        {"title":"Bottle",
         "url":"http://bottlepy.org/docs/dev/","views":99},
        {"title":"Flask",
